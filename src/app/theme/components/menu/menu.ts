...
export const verticalMenuItems = [
  ...
  // new Menu (2, 'Plan de Tareas', '/plan', null, 'next_plan', null, false, 0),
  new Menu (2, 'Usuarios', '/users', null, 'people', null, false, 0),
  new Menu (3, 'Ordenes de Trabajo', '/task', null, 'library_books', null, true, 0),
  new Menu (4, 'Servicios', '/task/services', null, 'view_agenda', null, false, 3),
  new Menu (5, 'Status', '/task/status', null, 'view_list', null, false, 3),
  new Menu (6, 'Reporte', '/task/report', null, 'event_note', null, false, 3),
  // new Menu (10, 'Catálogos', '/catalog', null, 'list_alt', null, true, 0),
  // new Menu (11, 'Equipos', '/catalog/equipment', null, 'corporate_fare', null, false, 10),
  // new Menu (12, 'Ubicaciones', '/catalog/locations', null, 'place', null, false, 10),
  // new Menu (13, 'Herramientas', '/catalog/tools', null, 'handyman', null, false, 10),
  // new Menu (14, 'Suministros', '/catalog/supplies', null, 'support', null, false, 10),
  // new Menu (15, 'Terceros', '/catalog/thirds', null, 'people_alt', null, false, 10),
  // new Menu (16, 'Administración', '/admin', null, 'settings', null, true, 0),
  new Menu (18, 'Ingreso OT', '/task/details/new', null, 'library_add', null, false, 0),
  // new Menu (19, 'Status', '/task/status', null, 'pageview', null, false, 0),
];


export const verticalMenuItems_template = [
    new Menu (1, 'Dashboard', '/', null, 'dashboard', null, false, 0),
